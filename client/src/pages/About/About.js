...
<div className="about" id="about">
          <div className="row">
            ...
            <div className="col-md-6 col-xl-6 col-lg-6 col-xs-12 about-content">
              <h1>About me</h1>
              <p>
                 Hello, my name is Akshat Tripathi. I am an aspiring Software Developer with a strong interest in Web Development and Artificial Intelligence/Machine Learning.
